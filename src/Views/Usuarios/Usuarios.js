    ...
    return <Container className="mt-5 mb-5">
        ...
        <div className="d-flex mb-5">
            ...
            <div className="ml-auto">
                <Button onClick={toggleModalNewUser}>Agregar</Button>
            </div>
        </div>

        <div className="grid-users">
            {users.map(user => (
                <User key={user.id} user={user} onDelete={onDelete} update={update} showAlert={showAlert} />
            ))}
        </div>
        ...
        <div className="pb-3 user d-flex position-relative">
            ...
            <div>
                <div className="font-weight-500">
                    <a className="text-capitalize" href="#user">{user.nombre}</a>
                </div>
