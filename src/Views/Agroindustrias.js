        ...
        <Row>
            <Col>
                <div className="DescripcionAgro">
                    <div className="logoEmpresa" style={{ position: 'relative', top: '-25px' }}>
                        <img src="https://image.freepik.com/free-psd/healthy-menu-promotion-social-media-instagram-post-banner-template_159024-228.jpg" className="imgLogoAgro" alt="Agroindustrias" />
                    </div>
                    <p>
            ...
            <Col>
                <div className="Circulo mt-5 cir1">
                    <img src="https://image.freepik.com/free-psd/healthy-menu-promotion-social-media-instagram-post-banner-template_159024-228.jpg" alt="Agroindustrias" />
                </div>
                ...
                <div className="position-relative">
                    <img src="https://image.freepik.com/free-psd/healthy-menu-promotion-social-media-instagram-post-banner-template_159024-228.jpg" alt="Agroindustrias" className="Bolsa" />
                </div>
            </Col>
        </Row>
