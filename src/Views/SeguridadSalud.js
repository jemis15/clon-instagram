...
export default function SeguridadSalud() {
    ...
    return < div className="container my-5 pb-5 " style={{border:'solid green'}}>
    <h4 className="text-center mb-4  p-4 mx-n3"  style={{ background:' #008000', color:'white'}}> Seguridad y Salud</h4>
