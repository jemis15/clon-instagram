...
export default function RegistroTurismo(){
    ...
    return <div className="container shadow my-5 p-5"    >
        ...
        <div className="mb-3 " style={{borderBottom:'6px solid #EDD016', color:'#008000'}}>
            ...
            <h3 style={{color:'#008000'}}> Registro Lugares Turísticos</h3>
        </div>
        <Form.Group >
            <Form.Label>Nombre Del Lugar:</Form.Label>
            <Form.Control type="text" placeholder="Nombre Lugar Turístico" />
        </Form.Group>
        <Form.Group >
        ...
        <div className="d-flex mt-3 mb-3">
            ...
            <div className="TablaOperadores border ml-3 p-3" style={styleScroll}>
                ...
                <Col sm="auto">
                <Button variant="info"  className="mb-3" href="/AgregarOperadores">
                    Registro
                </Button>
                </Col>
                </Row>
